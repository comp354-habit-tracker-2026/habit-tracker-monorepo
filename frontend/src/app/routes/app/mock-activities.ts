...
export const mockActivities: ActivityListItem[] = [
  ...
  },
  {
    ...
    activityType: 'ski',
    title: 'Sommet Saint-Sauveur',
    startedAt: '2026-03-25T16:16:36Z',
    endedAt: '2026-03-25T17:54:55Z',
    summary: {
  ...
  {
    id: 'mapmyrun-2026-03-27',
    source: 'map-my-run',
    sourceFormat: 'xlsx',
    activityType: 'bike-ride',
    title: 'Bike Ride',
    startedAt: '2026-03-27T14:00:00Z',
    endedAt: '2026-03-27T16:27:45Z',
    summary: {
      durationSeconds: 8865,
      distanceKm: 58.67,
      avgPaceMinPerKm: 2.4,
   ...
   {
    id: 'mapmyrun-2026-04-01',
    source: 'map-my-run',
    sourceFormat: 'xlsx',
    activityType: 'bike-ride',
    title: 'Bike Ride',
    startedAt: '2026-04-01T14:00:00Z',
    endedAt: '2026-04-01T16:27:45Z',
    summary: {
      durationSeconds: 10865,
      distanceKm: 65.67,
      avgPaceMinPerKm: 2.4,
      maxPaceMinPerKm: 1.61,
      avgSpeedKmh: 28.04,
   ...
   {
    id: 'mapmyrun-2026-04-2',
    source: 'map-my-run',
    sourceFormat: 'xlsx',
    activityType: 'bike-ride',
    title: 'Bike Ride',
    startedAt: '2026-04-02T14:00:00Z',
    endedAt: '2026-04-02T16:27:45Z',
    summary: {
      durationSeconds: 9674,
      distanceKm: 52.37,
      avgPaceMinPerKm: 3.1,
      maxPaceMinPerKm: 1.72,
      avgSpeedKmh: 23.71,
      maxSpeedKmh: 42.67,
      avgHeartRate: 142,
      calories: 937,
